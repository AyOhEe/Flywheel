...
public final class MaterialRenderState {
	...
	private static void setupTexture(Material material) {
		...
		AbstractTexture abstractTexture = Minecraft.getInstance()
				.getTextureManager()
				.getTexture(material.texture());
		abstractTexture.setFilter(material.blur(), material.mipmap());
		GlTexture glTexture = (GlTexture) abstractTexture.getTexture();
